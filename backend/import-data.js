...
async function importData() {
  ...
  try {
    ...
    await connection.execute('TRUNCATE TABLE inventory_logs');
    await connection.execute('TRUNCATE TABLE inventory_items');
    await connection.execute('TRUNCATE TABLE transport_tasks');
