...
const mockGoodsList = [
  { goodsId: 1, goodsName: '生鲜-蔬菜', safeStock: 100, currentStock: 80, status: '预警', warehouse: '库位A' },
  { goodsId: 2, goodsName: '标品-日用品', safeStock: 500, currentStock: 600, status: '正常', warehouse: '库位B' },
  { goodsId: 3, goodsName: '大件-家电', safeStock: 50, currentStock: 40, status: '预警', warehouse: '库位C' },
  { goodsId: 4, goodsName: '耗材-包装', safeStock: 200, currentStock: 250, status: '正常', warehouse: '库位D' }
];
