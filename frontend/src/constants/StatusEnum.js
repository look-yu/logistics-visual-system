...
export const ORDER_STATUS = {
  PENDING_ALLOCATE: { text: '待分配', type: 'primary', color: '#409EFF' }, // 蓝
  ALLOCATED: { text: '已分配', type: 'success', color: '#67C23A' }, // 绿
  EXCEPTION: { text: '异常', type: 'danger', color: '#F56C6C' }, // 红
  COMPLETED: { text: '已完成', type: 'info', color: '#909399' } // 灰
};
